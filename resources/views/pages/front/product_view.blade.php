...
@section('title', 'View Product || E-Shopper')
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span>BD {{ $product->product_price }} ৳</span>
								...
								<a href=""><img src="{{ asset('front/images/product-details/share.png') }}" class="share img-responsive"  alt="" /></a>
