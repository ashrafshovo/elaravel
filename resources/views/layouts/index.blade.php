				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{ route('index') }}"><img src="{{ asset('front/images/home/logo.png') }}" alt="" /></a>
						</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item {{ ($key+1 == 1)? 'active': '' }}">
								...
								<div class="col-sm-6">
									<img src="{{ asset('uploads/slider/'.$slider->slider_image) }}" class="girl img-responsive" alt="" />
									<img src="{{ asset('uploads/slider/pricing.png') }}"  class="pricing" alt="" />
								</div>
							</div>
							@endforeach
						</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{ route('manufacture.product', $manufacture->manufacture_id) }}"> <span class="pull-right">
										<?php 
											$manufacture_count = DB::table('tbl_products')
					                          ->where('tbl_products.manufacture_id', $manufacture->manufacture_id)
					                          ->where('tbl_products.publication_status', 1)
					                          ->get()
					                          ->count();
										?>
										({{ $manufacture_count }})
									</span>{{ $manufacture->manufacture_name }}</a></li>
									@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
			...
			<div class="container">
				<div class="row">
					<p class="pull-left">
						...
						E-SHOPPER Inc. All rights reserved.
					</p>
